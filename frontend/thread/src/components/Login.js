  ...
  return (
    <div className='w-screen h-screen flex items-center justify-center'>
      <div className='flex items-center justify-evenly w-[80%]'>
        <div>
          <img className='ml-5' width={"500px"} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQTsBRaKO-LvQ456rF5kzWtlWXgLsWSQBoVtA&s" alt="thread-logo" />
        </div>
        <div>
          <div className='my-5'>
            <h1 className='font-bold text-6xl'>Exploring now.</h1>
          </div>
